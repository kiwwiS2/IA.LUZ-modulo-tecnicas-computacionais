export const perguntas = [
    {
        enunciado: "Como você sente em relação as coisas que conquistou?",
        alternativas: [
            {
                texto: "Me sinto péssimo!",
                afirmacao: [
                    "Não consegui fazer absolutamente nada do que tinha vontade.",
                    "Fracassei em buscar meus objetivos."
                ],
                proxima: 1,
            },
            {
                texto: "Me sinto extremamnete bem!",
                afirmacao: [
